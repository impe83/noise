...
type Ping struct {
	NonEmpty bool `protobuf:"varint,1,opt,name=non_empty,json=nonEmpty,proto3" json:"non_empty,omitempty"`
}
...
func (this *Ping) VerboseEqual(that interface{}) error {
	...
	if this.NonEmpty != that1.NonEmpty {
		return fmt.Errorf("NonEmpty this(%v) Not Equal that(%v)", this.NonEmpty, that1.NonEmpty)
	}
	return nil
}
...
func (this *Ping) GoString() string {
	...
	s = append(s, "NonEmpty: "+fmt.Sprintf("%#v", this.NonEmpty)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *Ping) String() string {
	...
	s := strings.Join([]string{`&Ping{`,
		`NonEmpty:` + fmt.Sprintf("%v", this.NonEmpty) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Ping) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NonEmpty", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorStream = []byte{
	...
	,
}
